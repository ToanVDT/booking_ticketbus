...
public interface ShuttleRepository extends JpaRepository<Shuttle, Integer>{
	...
	@Query(nativeQuery = true,value = "select * from shuttle where shuttle.start_time=:startTime and shuttle.route_id=:routeId")
	Shuttle findExistsShuttle(LocalTime startTime, Integer routeId);
